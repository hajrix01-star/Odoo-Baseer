...
يشمل 17 موديولًا مخصصًا والاعتماديات الخارجية الموجودة في الإصدار المعتمد.
المستودع مخصص للكود؛ بيانات الموظفين والرواتب والعمليات والمرفقات وكلمات المرور ليست ضمنه.

## الإصدار الحالي

- أصل المصدر: `6104fc8e6f1d24b3e842f2b43bd9f410840d7759`.
- ملف `release-source.json` يثبت 1156 ملفًا ببصمات SHA256 وصورة Odoo المعتمدة.
